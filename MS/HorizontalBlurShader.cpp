...
void CHorizontalBlurShader::SetShaderData( ID3D11DeviceContext * context,
	...
	ID3D11ShaderResourceView * Texture, float TextureWidth )
{
	...
	( ( SPerObject* ) MappedResource.pData )->Width = TextureWidth;
...
{
	SetShaders( context );
	SetShaderData( context, OrtoMatrix, Texture, TextureWidth );
